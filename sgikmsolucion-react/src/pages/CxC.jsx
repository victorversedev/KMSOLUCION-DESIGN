...
import { 
  FiSearch, FiX, FiChevronDown, FiChevronRight, FiEdit, FiTrash2, FiDownload 
} from "react-icons/fi";
import "./CxC.css"; 
          ...
          <div className="modal-content" style={{maxWidth: '500px'}}>
            ...
            <form onSubmit={handleUpdate} className="insert-form">
              ...
              <div className="form-group">
                ...
                <input type="date" name="due_date" required value={formEntry.due_date} onChange={handleInputChange} />
              </div>
              <div className="form-group">
                <label>Monto</label>
